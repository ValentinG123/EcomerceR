...
const Favcard = ({ data, delOneFromFav, delAllFromFav, addToFav }) => {
  ...
  return (
    <div className="d-flex aling-items-center Fav-content">
      <div className="d-flex align-items-center mx-2">
        <img src={img} alt="" style={styleImg} />
      </div>
      <div className="img-Fav mx-1">
      ...
      <div className="d-flex justify-content-end w-100 align-items-center mx-3">
        <button
          onClick={() => delOneFromFav(id)}
          className="border-0 btn-bg btn-Fav ff h2"
        >
          -
        </button>
